...
| [velith](#velith) | Livros no nível humano — pipeline de publicação em 6 fases, 12 agentes, portão de prontidão, sistema visual. | [epicsagas/Velith](https://github.com/epicsagas/Velith) |
...
Navegue pelo catálogo com `/marketplace` na TUI do Grok.
...
A instalação direta também é suportada: `grok plugin install epicsagas/<repo> --trust`.
...
| wishket-radar | [epicsagas/wishket-radar](https://github.com/epicsagas/wishket-radar) | Radar de projetos do Wishket — busca, análise profunda e correspondência técnica de projetos de terceirização. |
