...
| [velith](#velith) | Des livres au niveau humain — pipeline de publication en 6 phases, 12 agents, verdict de maturité, système visuel. | [epicsagas/Velith](https://github.com/epicsagas/Velith) |
...
Parcourez le catalogue avec `/marketplace` dans le TUI Grok.
...
> `kanban-dev-lane` est réservé à Hermes — embarqué dans `.hermes/` de ce dépôt, non publié sur les marketplaces Claude/Codex.
...
L installation directe sans enregistrement de marketplace est également prise en charge : `grok plugin install epicsagas/<repo> --trust`.
...
| wishket-radar | [epicsagas/wishket-radar](https://github.com/epicsagas/wishket-radar) | Radar de projets Wishket — recherche, analyse approfondie et correspondance technique des projets d'externalisation. |
