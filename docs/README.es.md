...
| [velith](#velith) | Libros al nivel humano — pipeline de publicación en 6 fases, 12 agentes, compuerta de preparación, sistema visual. | [epicsagas/Velith](https://github.com/epicsagas/Velith) |
...
Explora el catálogo con `/marketplace` en Grok TUI.
...
> `kanban-dev-lane` es exclusivo de Hermes — incluido en `.hermes/` de este repo, no se publica en los marketplaces de Claude/Codex.
...
También se admite la instalación directa: `grok plugin install epicsagas/<repo> --trust`.
...
| wishket-radar | [epicsagas/wishket-radar](https://github.com/epicsagas/wishket-radar) | Radar de proyectos de Wishket — búsqueda, análisis profundo y emparejamiento técnico de proyectos de outsourcing. |
